...
////	FEVInterface* theFEWInterface = new FEWOtsUDPFSSRInterface(fecInterfaceNumber_, "OTS_UDP",
interfaceConfiguration_);
////	FEVInterface* theFEWInterface = new FEWZEDRyanInterface(fecInterfaceNumber_, "OTS_UDP",
interfaceConfiguration_);
//	FEVInterface* theFEWInterface = new FEWOtsGenericInterface(fecInterfaceNumber_, "OTS_UDP", "FSSR",
interfaceConfiguration_);
