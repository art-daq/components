...
//========================================================================================================================
FEOtsUDPTemplateInterface::FEOtsUDPTemplateInterface(const std::string &interfaceUID,
  ...
  if (1) {
...

    {
      ...
      unsigned short c = getFEMacroArgumentValue<unsigned short>(argsOut, "outArg1");
      __FE_COUTV__(a);
      __FE_COUTV__(b);
      __FE_COUTV__(c);
    }
...
void FEOtsUDPTemplateInterface::configure(void) {
  ...
  __FE_COUT__ << "Clearing receive socket buffer: " << OtsUDPHardware::clearReadSocket() << " packets cleared."
              << __E__;
  ...
  __FE_COUT__ << "Configuration Path Table: "
              << theXDAQContextConfigTree_.getNode(theConfigurationPath_).getConfigurationName() << "-v"
              << theXDAQContextConfigTree_.getNode(theConfigurationPath_).getConfigurationVersion() << __E__;
...
void ots::FEOtsUDPTemplateInterface::universalRead(char *address, char *returnValue) {
  ...
  for (unsigned int i = 0; i < universalDataSize_; ++i) printf("%2.2X", (unsigned char)returnValue[i]);
  std::cout << __E__;
...
void ots::FEOtsUDPTemplateInterface::universalWrite(char *address, char *writeValue) {
  ...
  for (unsigned int i = 0; i < universalDataSize_; ++i) printf("%2.2X", (unsigned char)writeValue[i]);
  std::cout << __E__;
...
void FEOtsUDPTemplateInterface::varTest(__ARGS__) {
  ...
  for (auto &argIn : argsIn) __FE_COUT__ << argIn.first << ": " << argIn.second << __E__;
  ...
  // macro commands section
  {
    ...
    macroArgs["myOtherArg"] =
        __GET_ARG_IN__("myOtherArg", uint64_t);  // initialize from input arguments	//get macro data argument
  ...
  for (auto &argOut : argsOut) __FE_COUT__ << argOut.first << ": " << argOut.second << __E__;
