...
FEOtsUDPFSSRInterfaceConfiguration::FEOtsUDPFSSRInterfaceConfiguration(void)
    : FEInterfaceTableBase("FEOtsUDPFSSRInterfaceConfiguration")
{
	//////////////////////////////////////////////////////////////////////
...
//==============================================================================
unsigned int FEOtsUDPFSSRInterfaceConfiguration::getFirmwareVersion(
...
//==============================================================================
std::string FEOtsUDPFSSRInterfaceConfiguration::getIPAddress(
    std::string interfaceID) const
{
...
//==============================================================================
std::string FEOtsUDPFSSRInterfaceConfiguration::getInterfaceIPAddress(
    std::string interfaceID) const
{
...
//==============================================================================
unsigned int FEOtsUDPFSSRInterfaceConfiguration::getInterfacePort(
    std::string interfaceID) const
{
...
//==============================================================================
std::string FEOtsUDPFSSRInterfaceConfiguration::getStreamingIPAddress(
    std::string interfaceID) const
{
...
//==============================================================================
unsigned int FEOtsUDPFSSRInterfaceConfiguration::getStreamingPort(
    std::string interfaceID) const
{
...
//==============================================================================
std::string FEOtsUDPFSSRInterfaceConfiguration::getClockSelect(
    std::string interfaceID) const
{
...
//==============================================================================
bool FEOtsUDPFSSRInterfaceConfiguration::getChannelStatus(std::string  interfaceID,
