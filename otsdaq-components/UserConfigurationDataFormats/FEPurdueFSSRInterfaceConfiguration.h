#ifndef _ots_FEPurdueFSSRInterfaceConfiguration_h_
#define _ots_FEPurdueFSSRInterfaceConfiguration_h_
...
class FEPurdueFSSRInterfaceConfiguration : public FEInterfaceConfigurationBase
{

public:

    FEPurdueFSSRInterfaceConfiguration(void);
    virtual ~FEPurdueFSSRInterfaceConfiguration(void);
