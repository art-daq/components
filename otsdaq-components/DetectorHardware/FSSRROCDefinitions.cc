...
//========================================================================================================================
uint64_t FSSRROCDefinitions::makeDACWriteHeader(int chipId, const std::string& registerName)
{
...
//========================================================================================================================
uint64_t FSSRROCDefinitions::makeDACResetHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, reset);
}

//========================================================================================================================
uint64_t FSSRROCDefinitions::makeDACReadHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, read);
}

//========================================================================================================================
uint64_t FSSRROCDefinitions::makeDACHeader(int chipId, const std::string& registerName, unsigned int instruction)
{
/*Ryan
    uint64_t command = 0;
    //Insert Chip ID
...
//========================================================================================================================
uint64_t FSSRROCDefinitions::makeDACWriteCommand(int chipId, const std::string& registerName, unsigned int valueToWrite)
{
...
//========================================================================================================================
uint64_t FSSRROCDefinitions::makeDACReadCommand(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, read);
}

//========================================================================================================================
std::string FSSRROCDefinitions::makeMaskWriteCommand (int chipId, const std::string& registerName, std::string valueToWrite)
{
...
/*Ryan's
    ...
    for (int i=0; i<19; i++)
    {
    	std::cout << __COUT_HDR_FL__ << std::hex << (uint64_t)command.substr(i, 1).data()[0] << "-" << std::dec << std::endl;
    }
...
//========================================================================================================================
uint64_t FSSRROCDefinitions::makeMaskReadCommand (int chipId, const std::string& registerName)
{
    return 0;
}
