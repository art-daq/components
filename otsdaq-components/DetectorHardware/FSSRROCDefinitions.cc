...
//========================================================================================================================
uint64_t FSSRROCDefinitions::makeDACWriteCommand(int chipId, const std::string& registerName,
...
//========================================================================================================================
std::string FSSRROCDefinitions::makeMaskWriteCommand(int chipId, const std::string& registerName,
  ...
  /*Ryan's
      ...
      for (int i=0; i<19; i++)
      {
          std::cout << __COUT_HDR_FL__ << std::hex << (uint64_t)command.substr(i, 1).data()[0] << "-" << std::dec <<
     std::endl;
      }
...
//========================================================================================================================
uint64_t FSSRROCDefinitions::makeMaskReadCommand(int chipId, const std::string& registerName) { return 0; }

//========================================================================================================================
uint64_t FSSRROCDefinitions::setSendData(int chipId) { return makeDACWriteCommand(chipId, "SendData", 1); }

//========================================================================================================================
uint64_t FSSRROCDefinitions::resetSendData(int chipId) { return makeDACWriteCommand(chipId, "SendData", 0); }

//========================================================================================================================
uint64_t FSSRROCDefinitions::setRejectHits(int chipId) { return makeDACWriteCommand(chipId, "RejectHits", 1); }

//========================================================================================================================
uint64_t FSSRROCDefinitions::resetRejectHits(int chipId) { return makeDACWriteCommand(chipId, "RejectHits", 0); }
