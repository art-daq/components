...
//========================================================================================================================
uint64_t VIPICROCDefinitions::makeDACWriteHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, write);
}

//========================================================================================================================
uint64_t VIPICROCDefinitions::makeDACSetHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, set);
}

//========================================================================================================================
uint64_t VIPICROCDefinitions::makeDACResetHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, reset);
}

//========================================================================================================================
uint64_t VIPICROCDefinitions::makeDACReadHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, read);
}

//========================================================================================================================
uint64_t VIPICROCDefinitions::makeDACHeader(int chipId, const std::string& registerName, unsigned int instruction)
{
/*Ryan
    uint64_t command = 0;
    //Insert Chip ID
...
//========================================================================================================================
uint64_t VIPICROCDefinitions::makeDACWriteCommand(int chipId, const std::string& registerName, unsigned int valueToWrite)
{
...
//========================================================================================================================
uint64_t VIPICROCDefinitions::makeDACReadCommand(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, read);
}

//========================================================================================================================
std::string VIPICROCDefinitions::makeMaskWriteCommand (int chipId, const std::string& registerName, std::string valueToWrite)
{
...
//========================================================================================================================
uint64_t VIPICROCDefinitions::makeMaskReadCommand (int chipId, const std::string& registerName)
{
    return 0;
}
