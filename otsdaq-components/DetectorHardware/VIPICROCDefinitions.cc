...
//========================================================================================================================
uint64_t VIPICROCDefinitions::makeDACWriteCommand(int chipId, const std::string& registerName,
...
//========================================================================================================================
std::string VIPICROCDefinitions::makeMaskWriteCommand(int chipId, const std::string& registerName,
...
//========================================================================================================================
uint64_t VIPICROCDefinitions::makeMaskReadCommand(int chipId, const std::string& registerName) { return 0; }

//========================================================================================================================
uint64_t VIPICROCDefinitions::setSendData(int chipId) { return makeDACWriteCommand(chipId, "SendData", 1); }

//========================================================================================================================
uint64_t VIPICROCDefinitions::resetSendData(int chipId) { return makeDACWriteCommand(chipId, "SendData", 0); }

//========================================================================================================================
uint64_t VIPICROCDefinitions::setRejectHits(int chipId) { return makeDACWriteCommand(chipId, "RejectHits", 1); }

//========================================================================================================================
uint64_t VIPICROCDefinitions::resetRejectHits(int chipId) { return makeDACWriteCommand(chipId, "RejectHits", 0); }
