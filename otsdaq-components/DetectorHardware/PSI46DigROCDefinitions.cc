...
//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeDACWriteCommand(int chipId, const std::string& registerName,
                                                     unsigned int valueToWrite) {
  std::cout << __COUT_HDR_FL__ << "Working on Register " << registerName
            << " Address: " << getDACRegisterAddress(registerName) << " Value: " << valueToWrite << std::endl;
  uint64_t command = 0;
...
//========================================================================================================================
std::string PSI46DigROCDefinitions::makeMaskWriteCommand(int chipId, const std::string& registerName,
...
//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeMaskReadCommand(int chipId, const std::string& registerName) { return 0; }

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::setSendData(int chipId) { return makeDACWriteCommand(chipId, "SendData", 1); }

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::resetSendData(int chipId) { return makeDACWriteCommand(chipId, "SendData", 0); }

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::setRejectHits(int chipId) { return makeDACWriteCommand(chipId, "RejectHits", 1); }

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::resetRejectHits(int chipId) { return makeDACWriteCommand(chipId, "RejectHits", 0); }
