...
//========================================================================================================================
unsigned int PSI46DigROCDefinitions::getDACRegisterAddress(const std::string& registerName)
{
    if      (registerName == "PulserData"   ) return  1;
    else if (registerName == "PulserControl") return  2;
    else if (registerName == "IntegratorVbn") return  3;
    else if (registerName == "ShaperVbp2"   ) return  4;
    else if (registerName == "ShaperVbp1"   ) return  5;
    else if (registerName == "BLRestorer"   ) return  6;
    else if (registerName == "VTn"          ) return  7;
    else if (registerName == "VTp0"         ) return  8;
    else if (registerName == "VTp1"         ) return  9;
    else if (registerName == "VTp2"         ) return 10;
    else if (registerName == "VTp3"         ) return 11;
    else if (registerName == "VTp4"         ) return 12;
    else if (registerName == "VTp5"         ) return 13;
    else if (registerName == "VTp6"         ) return 14;
    else if (registerName == "VTp7"         ) return 15;
    else if (registerName == "ActiveLines"  ) return 16;
    else if (registerName == "SendData"     ) return 19;
    else if (registerName == "RejectHits"   ) return 20;
    else if (registerName == "DigContrReg"  ) return 27;
    else if (registerName == "AqBCO"        ) return 30;
    //Kill and Inject are GENERAL names that will be used for all ROCs
    else if (registerName == "Kill"         ) return 17;
    else if (registerName == "Inject"       ) return 18;
    else
    {
...
//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeDACWriteHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, write);
}

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeDACSetHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, set);
}

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeDACResetHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, reset);
}

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeDACReadHeader(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, read);
}

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeDACHeader(int chipId, const std::string& registerName, unsigned int instruction)
{
/*Ryan
    uint64_t command = 0;
    //Insert Chip ID
...
//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeDACWriteCommand(int chipId, const std::string& registerName, unsigned int valueToWrite)
{
    std::cout << __COUT_HDR_FL__ << "Working on Register " << registerName << " Address: " << getDACRegisterAddress(registerName) << " Value: " << valueToWrite << std::endl;
    uint64_t command = 0;
    if (registerName != "SendData" && registerName != "RejectHits")
    {
        command = makeDACWriteHeader(chipId, registerName);
        BitManipulator::insertBits(command,BitManipulator::reverseBits(valueToWrite,0,8),13,8);
    }
    else
        if (valueToWrite == 1)
    ...
    //BitManipulator::insertBits(command,0x0,13,8);It doesn't matter the value you put in if is set or reset!

    return command;
}

//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeDACReadCommand(int chipId, const std::string& registerName)
{
    return makeDACHeader(chipId, registerName, read);
}

//========================================================================================================================
std::string PSI46DigROCDefinitions::makeMaskWriteCommand (int chipId, const std::string& registerName, std::string valueToWrite)
{
...
/*Ryan's
    ...
    for (int i=0; i<19; i++)
    {
    	std::cout << __COUT_HDR_FL__ << hex << (uint64_t)command.substr(i, 1).data()[0] << "-" << std::endl;
    }
...
//========================================================================================================================
uint64_t PSI46DigROCDefinitions::makeMaskReadCommand (int chipId, const std::string& registerName)
{
    return 0;
}
