...
//    protocolInstance_->write(buffer, STRIP_TRIG_INPUT_2, 0x0); //  PSI46Dig GOTHIT trigger input channel 4,5
//}
//
///*
// //========================================================================================================================
...
//
// //========================================================================================================================
// void PSI46DigFirmware::setBCO_0(uint32_t void PSI46DigFirmware::BCOOffset(uint32_t offset)
// {
...
////    setPacketSizeStripCSR(6);
////    setExternalBCOClockSourceStripCSR(source); //(source)
////    write(buffer, STRIP_CSR, stripCSRRegisterValue_); //  Reset CSR - reset trigger counter, external 27 MHz clock
////
////    resetDCMStripCSR(true);
...
////
////    write(buffer, STRIP_TRIM_CSR, 0x00002000); //  MCLKB edge for channel 5 // was 0x00002000
////
////    setFrequencyFromClockState(buffer, frequency);
...
////        waitClear(buffer, STRIP_RESET, 0xf0000000); //  Wait for reset to complete // was 0xf0000000
////    } else
////    {
////        write(buffer, STRIP_RESET, 0xf000003f); //  Issue reset
...
////
////    if (version_ == 1)
////        write(buffer, STRIP_TRIG_INPUT_3, 0x20401000); // Turn on streaming hits along with BCO data
////    else if (version_ == 2)
////        write(buffer, STRIP_TRIG_INPUT_3, 0x20301000); // Turn on streaming hits along with BCO data
////    else
////    {
////    	std::cout << __COUT_HDR_FL__ << __PRETTY_FUNCTION__ << "what version is this?" << version_ << std::endl;
////	assert(0);
...
////        sequence.pushBack(ChannelFIFOAddress[channel], it->second.second);
////        std::cout << __COUT_HDR_FL__ << __PRETTY_FUNCTION__ << "Register: " << it->first << " value: "
////        << it->second.second << hex << " -> Data: " << data << dec
////        << std::endl;
////        sequence.pushBack(STRIP_SC_CSR, data);
////    }
////}
...
////
//////========================================================================================================================
////unsigned int PSI46DigFirmware::write(std::string& buffer, unsigned int address, unsigned int data)
////{
...
////
//////========================================================================================================================
////string PSI46DigFirmware::compareSendAndReceive(const std::string& sentBuffer, std::string& acknowledgment)
////{
...
////
//////========================================================================================================================
////uint32_t PSI46DigFirmware::createRegisterFromValue(std::string& readBuffer, std::string& receivedValue)
////{
...
////{
////    write(buffer, STRIP_TRIG_INPUT_0, 0x3f440000); //  PSI46Dig GOTHIT trigger input channel 0,1
////    write(buffer, STRIP_TRIG_INPUT_1, 0x3f440000); //  PSI46Dig GOTHIT trigger input channel 2,3
////    write(buffer, STRIP_TRIG_INPUT_2, 0x0);        //  PSI46Dig GOTHIT trigger input channel 4,5
////}
////
//
