...
public:
    ...
    virtual std::string  setDataDestination          (std::string ip, uint32_t port){__SS__; throw std::runtime_error(ss.str() + "Illegal call to undefined base class member function"); return "";};
